var ATversion='Zek v3.2.1',atscript=document.getElementById('AutoTrimps-script'),basepath='https://cassfantastic.github.io/ZT/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
