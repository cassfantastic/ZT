...
function initializeAllSettings() {
    ...
    //RPortal
    document.getElementById('RBuyUpgradesNew').parentNode.insertAdjacentHTML('afterend', '<br>');
    ...
    //document.getElementById("RadonHourChallengeLabel").innerHTML = "Portal Challenge:";
